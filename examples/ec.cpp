...
int main() {
  ...
  printf("Verifying against correct signature: %s\n",
         FIPS_186_5_6_4_2_VerifySignature(sig, msg, key->group, key->pub) == 0
             ? "Passed!"
             : "Failed!");
  /* Return code of -1 indicates signature match failed */
  printf("Verifying against wrong signature: %s\n",
         FIPS_186_5_6_4_2_VerifySignature(mySig2, msg, key->group, key->pub) ==
                 -1
             ? "Passed!"
             : "Failed!");
  ...
  printf("Verifying against wrong key: %s\n",
         FIPS_186_5_6_4_2_VerifySignature(sig, msg, myKey2->group,
                                          myKey2->pub) == -1
             ? "Passed!"
             : "Failed!");
  ...
  printf("Verifying against wrong message: %s\n",
         FIPS_186_5_6_4_2_VerifySignature(sig, foobar, key->group, key->pub) ==
                 -1
             ? "Passed!"
             : "Failed!");
